...
from _PythonProject.YellowPerson.img_data import dataset
from _PythonProject.YellowPerson.net import cnn_net
...
if __name__ == '__main__':
    data_set = dataset("D:\PyCharmProject\AiProject1\YellowPerson\img\dtag")
