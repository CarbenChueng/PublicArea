...
bg_path = "D:/PyCharmProject/AiProject1/YellowPerson/img/data"
x = 1
for filename in os.listdir(bg_path):
    ...
    background_resize.save("D:/PyCharmProject/AiProject1/YellowPerson/img/tag/{0}{1}.png".format(x,"."+str(ran_x1)+"."+str(ran_y1)+
